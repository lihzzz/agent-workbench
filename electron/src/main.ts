...
import * as subagentsIpc from "./ipc/subagents";
import * as promptTemplatesIpc from "./ipc/prompt-templates";
...
subagentsIpc.register();
promptTemplatesIpc.register();
