...
// ── Agent Workbench logo mark — a stylized "H" rendered inline ──
          ...
          <div className="mt-6 border-t border-foreground/[0.06] pt-4">
            ...
            <div className="-mx-3 mt-2 flex flex-col gap-0.5">
              <AboutLink
                ...
                href="https://github.com/lihzzz/agent-workbench"
                description="Source code, issues &amp; releases"
              />
              <AboutLink
                icon={Scale}
                label="MIT License"
                href="https://github.com/lihzzz/agent-workbench/blob/main/LICENSE"
            ...
            <div className="mt-3 rounded-xl border border-foreground/[0.06] bg-muted/20 px-4 py-3.5">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[13px] font-medium text-foreground/90">
                  Maintained by lihzzz
                </span>
              </div>
              <p className="mt-1.5 text-xs leading-relaxed text-muted-foreground">
                Agent Workbench is open-source under the MIT License. Contributions, bug reports,
