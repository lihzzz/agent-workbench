...
export interface SlashCommand {
  ...
  source: "claude" | "acp" | "codex" | "codex-skill" | "codex-app" | "local" | "template";
  ...
  iconUrl?: string;
  /** For prompt templates: the raw body (may contain {{variables}}) to insert. */
  templateBody?: string;
}

/** All supported engine identifiers. */
export type EngineId = "claude" | "acp" | "codex" | "opencode";
