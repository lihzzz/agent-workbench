...
export const EnginePickerDropdown = memo(function EnginePickerDropdown({
  ...
  const isOpenCodeAgent = selectedAgent?.engine === "opencode";
  ...
  const configItems = (
    <>
      ...
      {!isCodexAgent && !isACPAgent && !isOpenCodeAgent && claudeEffortOptions.length > 0 && (
        <>
          <DropdownMenuSeparator />
  ...
  // Split first-party engines from registry-backed ACP agents.
